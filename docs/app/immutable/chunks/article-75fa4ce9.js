...
function create_fragment$1(ctx) {
  ...
  return {
    ...
    l(nodes) {
      ...
      img0 = claim_element(a1_nodes, "IMG", { src: true, alt: true, class: true });
      ...
      img2 = claim_element(a3_nodes, "IMG", { src: true, alt: true, class: true });
      a3_nodes.forEach(detach);
      t4 = claim_space(aside_nodes);
      a4 = claim_element(aside_nodes, "A", { href: true, class: true });
      var a4_nodes = children(a4);
      img3 = claim_element(a4_nodes, "IMG", { src: true, alt: true, class: true });
...
function create_fragment(ctx) {
  ...
  return {
    ...
    h() {
      attr(article, "class", "svelte-1jo1u5n");
    },
    m(target, anchor) {
