...
function create_fragment$1(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(main, "class", "svelte-18wqezn");
      if (!src_url_equal(img4.src, img4_src_value = "/cliff.gif"))
        attr(img4, "src", img4_src_value);
      attr(img4, "alt", "");
      attr(img4, "width", "1440");
      attr(img4, "height", "810");
      attr(img4, "class", "svelte-18wqezn");
      attr(section, "class", "svelte-18wqezn");
      attr(header, "class", "svelte-18wqezn");
    },
    m(target, anchor) {
